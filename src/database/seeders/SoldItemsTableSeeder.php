...
class SoldItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'item_img' => 'storage/sold_items/1.jpg',
            'item_price' => '777'
        ];
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/2.jpg',
            'item_price' => '5000'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/3.jpg',
            'item_price' => '700'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/4.jpg',
            'item_price' => '3500'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/5.jpg',
            'item_price' => '4000'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/6.jpg',
            'item_price' => '1600'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/7.jpg',
            'item_price' => '1500'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/8.jpg',
            'item_price' => '4500'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/9.jpg',
            'item_price' => '2000'
        ];
        DB::table('sold_items')->insert($param);
        ...
        $param = [
            ...
            'item_img' => 'storage/sold_items/10.jpg',
            'item_price' => '5000'
        ];
        DB::table('sold_items')->insert($param);
